...
from .capteur import *
from .superviseur import Superviseur    #On a besoin du superviseur pour l'initialisation, mais le robot n'est pas cense le controller
                                        #on importe donc juste le constructeur
import formules as fm
from view.viewer import LARGEUR, HAUTEUR
...
class Robot:
    ...
    def __init__(self, nom, couleur):
        ...
        self.nom = nom
        self.x = LARGEUR/2  # coordonnees
        self.y = HAUTEUR/2  # absolues
        self.direction = [0,1]
