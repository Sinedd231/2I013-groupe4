...
class Obstacle:
	...
	@staticmethod
	def create_and_disp_obstacle(canvas,nbr):
		""" permet de creer un tableau d'obstacles, de le retourner et d'afficher ces obstacles
		...
		for i in range(1,nbr+1):
			...
			obstacle= Obstacle(random.uniform(*random.choice( [(0,310),(430,820)] )), random.uniform(0,820), random.uniform(15,50), random.uniform(15,50))
			...
			on va donc selectionner au hasard l'intervalle [0,310] ou [430,820] avec random.choice, ce qui exclut l'intervalle ]310,430[
