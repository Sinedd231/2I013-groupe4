...
import time
from MVC.controller.strategies import SquareStrat, LigneStrat, TournerDroiteStrat, TriangleStrat, PolygoneStrat
...
class Main:
    ...
    def init_sim(self):
        ...
        self.superviseur= Superviseur(self.robot, PolygoneStrat(self,8))
