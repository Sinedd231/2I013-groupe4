...
import time
from MVC.controller.strategies import SquareStrat, LigneStrat, TournerDroiteStrat, TriangleStrat
...
class Main:
    ...
    def init_sim(self):
        ...
        self.superviseur= Superviseur(self.robot, TriangleStrat(self))
