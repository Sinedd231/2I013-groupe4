...
class Obstacle:
    ...
    def create_and_disp_obstacle(canvas,nbr):
        ...
        for i in range(1,nbr+1):
            ...
            obstacle= Obstacle(random.uniform(*random.choice( [(0,310),(430,850)] )), random.uniform(0,850), random.uniform(15,50), random.uniform(15,50))
            ...
            #on va donc selectionner au hasard l'intervalle [0,310] ou [430,850] avec random.choice, ce qui exclut l'intervalle ]310,430[
